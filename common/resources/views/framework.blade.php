...
<head>
    ...
    <meta name="theme-color" content="rgb({{$bootstrapData->getSelectedTheme()->getHtmlThemeColor()}})">
...
@if ($code = $settings->get('analytics.tracking_code'))
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-{{$settings->get('analytics.tracking_code')}}"/>
    <script>
